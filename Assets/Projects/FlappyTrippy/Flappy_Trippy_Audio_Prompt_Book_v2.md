...
- **Global Constraints:** Maintain a crisp, zero muddy-reverb aesthetic to match the Line-art graphic style. Avoid overly long decay tails so sounds don't bleed into each other during fast gameplay.
